...
def main():
  ...
  parser.add_argument("-t", "--threads", metavar="", type=int, default=10, help="Number of threads to use (default=10)")
  ...
  parser.add_argument("--megan", action="store_true", help="Run Diamond and Megan with GB db")
